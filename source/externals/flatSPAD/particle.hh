...
public:
    ...
    /**
     * @brief Use the xray_globalTime to determine if it's smaller then the other.
    ...
    /**
     * @brief Use the xray_globalTime to determine if it's bigger then the other.
     * @param other The others Particle used for comparing.
     * @return bool
     */
    bool operator>(const Particle& other) const;
    ...
    /**
     * @brief Use the xray_globalTime to determine if it's smaller or equal then the other.
     * @param other The others Particle used for comparing.
     * @return bool
     */
    bool operator<=(const Particle& other) const;
    ...
    /**
     * @brief Use the xray_globalTime to determine if it's bigger or equal then the other.
     * @param other The others Particle used for comparing.
     * @return bool
     */
    bool operator>=(const Particle& other) const;
    ...
    /**
     * @brief Use the xray_globalTime to determine if it's equal to the other.
     * @param other The others Particle used for comparing.
     * @return bool
     */
    bool operator==(const Particle& other) const;
    ...
    /**
     * @brief Use the xray_globalTime to determine if it's not equal to the other.
     * @param other The others Particle used for comparing.
     * @return bool
     */
    bool operator!=(const Particle& other) const;
    ...
    /**
     * @brief Return the xray_globalTime of the Particle.
     * @return const double&
     */
    ...
    */
    ...
    /**
     * @brief Add time to the xray_globalTime.
     */
