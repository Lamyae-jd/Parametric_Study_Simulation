...
, matrix(nullptr)
, silicon(nullptr)
, quenchFactory(nullptr)
, matrixFactory(nullptr)
, siliconFactory(nullptr)
{}
...
void ISimulator::setSimulationTime(double max_event_time) {
    quench->setProperty(IQuench::MAX_EVENT_TIME,new VarType(max_event_time));
}
