...
class GateRootHitBuffer
{
  public:
    ...
    std::vector<G4double> *phantomComptonHitTime;
    std::vector<G4double> *phantomComptonHitPosX;
    std::vector<G4double> *phantomComptonHitPosY;
    std::vector<G4double> *phantomComptonHitPosZ;
    std::vector<G4double> *phantomRayleighHitPosX;
    std::vector<G4double> *phantomRayleighHitPosY;
    std::vector<G4double> *phantomRayleighHitPosZ;
    std::vector<G4double> *phantomRayleighHitTime;
    //@}
