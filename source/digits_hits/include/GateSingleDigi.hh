...
public:
      ...
      inline void     SetTimeOfFlight(G4double aTime)    { m_pulse.SetTimeOfFlight(aTime); }
      inline G4double GetTimeOfFlight() const                { return  m_pulse.GetTimeOfFlight(); }

      inline void SetPhantomComptonHitPosX(std::shared_ptr<std::vector<G4double>> p) { m_pulse.SetPhantomComptonHitPosX(p); }
      inline std::shared_ptr<std::vector<G4double>> GetPhantomComptonHitPosX() const { return m_pulse.GetPhantomComptonHitPosX(); }

      inline void SetPhantomComptonHitPosY(std::shared_ptr<std::vector<G4double>> p) { m_pulse.SetPhantomComptonHitPosY(p); }
      inline std::shared_ptr<std::vector<G4double>> GetPhantomComptonHitPosY() const { return m_pulse.GetPhantomComptonHitPosY(); }

      inline void SetPhantomComptonHitPosZ(std::shared_ptr<std::vector<G4double>> p) { m_pulse.SetPhantomComptonHitPosZ(p); }
      inline std::shared_ptr<std::vector<G4double>> GetPhantomComptonHitPosZ() const { return m_pulse.GetPhantomComptonHitPosZ(); }

      inline void SetPhantomComptonHitTime(std::shared_ptr<std::vector<G4double>> p) {m_pulse.SetPhantomComptonHitTime(p); }
      inline std::shared_ptr<std::vector<G4double>> GetPhantomComptonHitTime() const { return m_pulse.GetPhantomComptonHitTime();  }

      inline void SetPhantomRayleighHitPosX(std::shared_ptr<std::vector<G4double>> p) { m_pulse.SetPhantomRayleighHitPosX(p);  }
      inline std::shared_ptr<std::vector<G4double>> GetPhantomRayleighHitPosX() const { return m_pulse.GetPhantomRayleighHitPosX();  }

      inline void SetPhantomRayleighHitPosY(std::shared_ptr<std::vector<G4double>> p) { m_pulse.SetPhantomRayleighHitPosY(p);  }
      inline std::shared_ptr<std::vector<G4double>> GetPhantomRayleighHitPosY() const { return m_pulse.GetPhantomRayleighHitPosY();  }

      inline void SetPhantomRayleighHitPosZ(std::shared_ptr<std::vector<G4double>> p) { m_pulse.SetPhantomRayleighHitPosZ(p);  }
      inline std::shared_ptr<std::vector<G4double>> GetPhantomRayleighHitPosZ() const { return m_pulse.GetPhantomRayleighHitPosZ();  }

      inline void SetPhantomRayleighHitTime(std::shared_ptr<std::vector<G4double>> p) { m_pulse.SetPhantomRayleighHitTime(p);  }
      inline std::shared_ptr<std::vector<G4double>> GetPhantomRayleighHitTime() const { return m_pulse.GetPhantomRayleighHitTime();  }
