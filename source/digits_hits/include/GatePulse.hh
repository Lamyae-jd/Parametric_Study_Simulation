...
public:
    ...
    inline void     SetTimeOfFlight(G4double aTime)    { m_timeOfFlight = aTime; }
    inline G4double GetTimeOfFlight() const                { return m_timeOfFlight; }
    ...
    inline void SetPhantomComptonHitPosX(std::shared_ptr<std::vector<G4double>> p) { m_phantomComptonHitPosXVec = p; }
    inline std::shared_ptr<std::vector<G4double>> GetPhantomComptonHitPosX() const { return m_phantomComptonHitPosXVec; }

    inline void SetPhantomComptonHitPosY(std::shared_ptr<std::vector<G4double>> p) { m_phantomComptonHitPosYVec = p; }
    inline std::shared_ptr<std::vector<G4double>> GetPhantomComptonHitPosY() const { return m_phantomComptonHitPosYVec; }

    inline void SetPhantomComptonHitPosZ(std::shared_ptr<std::vector<G4double>> p) { m_phantomComptonHitPosZVec = p; }
    inline std::shared_ptr<std::vector<G4double>> GetPhantomComptonHitPosZ() const { return m_phantomComptonHitPosZVec; }

    inline void SetPhantomComptonHitTime(std::shared_ptr<std::vector<G4double>> p) { m_phantomComptonHitTimeVec = p; }
    inline std::shared_ptr<std::vector<G4double>> GetPhantomComptonHitTime() const { return m_phantomComptonHitTimeVec; }

    inline void SetPhantomRayleighHitPosX(std::shared_ptr<std::vector<G4double>> p) { m_phantomRayleighHitPosXVec = p; }
    inline std::shared_ptr<std::vector<G4double>> GetPhantomRayleighHitPosX() const { return m_phantomRayleighHitPosXVec; }

    inline void SetPhantomRayleighHitPosY(std::shared_ptr<std::vector<G4double>> p) { m_phantomRayleighHitPosYVec = p; }
    inline std::shared_ptr<std::vector<G4double>> GetPhantomRayleighHitPosY() const { return m_phantomRayleighHitPosYVec; }

    inline void SetPhantomRayleighHitPosZ(std::shared_ptr<std::vector<G4double>> p) { m_phantomRayleighHitPosZVec = p; }
    inline std::shared_ptr<std::vector<G4double>> GetPhantomRayleighHitPosZ() const { return m_phantomRayleighHitPosZVec; }
    inline void SetPhantomRayleighHitTime(std::shared_ptr<std::vector<G4double>> p) { m_phantomRayleighHitTimeVec = p; }
    inline std::shared_ptr<std::vector<G4double>> GetPhantomRayleighHitTime() const { return m_phantomRayleighHitTimeVec; }
...
private:
    ...
    G4double m_timeOfFlight;        //!< Time from the emission to the detection of the current pulse
    ...
    //@}
    std::shared_ptr<std::vector<G4double>> m_phantomComptonHitTimeVec;
    std::shared_ptr<std::vector<G4double>> m_phantomComptonHitPosXVec;
    std::shared_ptr<std::vector<G4double>> m_phantomComptonHitPosYVec;
    std::shared_ptr<std::vector<G4double>> m_phantomComptonHitPosZVec;
    std::shared_ptr<std::vector<G4double>> m_phantomRayleighHitPosXVec;
    std::shared_ptr<std::vector<G4double>> m_phantomRayleighHitPosYVec;
    std::shared_ptr<std::vector<G4double>> m_phantomRayleighHitPosZVec;
    std::shared_ptr<std::vector<G4double>> m_phantomRayleighHitTimeVec;
