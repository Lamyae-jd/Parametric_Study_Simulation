...
const GatePulse& GatePulse::CentroidMerge(const GatePulse* right)
{
    ...
    m_timeOfFlight = std::min ( m_timeOfFlight , right->m_timeOfFlight ) ;
...
std::ostream& operator<<(std::ostream& flux, const GatePulse& pulse)
{
    flux    << "\t----GatePulse----"     	      	      	      	      	      	      	      	      	      	               << Gateendl
            ...
            << "\t\t" << "Time          " << G4BestUnit(pulse.m_time,"Time")
            << "\t\t" << "TimeOfFlight          " << G4BestUnit(pulse.m_timeOfFlight,"TimeOfFlight")      	      	      	      	      	       << Gateendl
