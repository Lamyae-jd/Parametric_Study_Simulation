...
// Looking at Crystal Hits Collection:
  if (CHC) {
    ...
    (*CHC)[iHit]->SetPhantomComptonHitPosX   (nullptr);
    (*CHC)[iHit]->SetPhantomComptonHitPosY   (nullptr);
    (*CHC)[iHit]->SetPhantomComptonHitPosZ   (nullptr);
    (*CHC)[iHit]->SetPhantomRayleighHitPosX   (nullptr);
    (*CHC)[iHit]->SetPhantomRayleighHitPosY   (nullptr);
    (*CHC)[iHit]->SetPhantomRayleighHitPosZ   (nullptr);
    (*CHC)[iHit]->SetPhantomComptonHitTime   (nullptr);
    (*CHC)[iHit]->SetPhantomRayleighHitTime   (nullptr);
